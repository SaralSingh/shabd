...
<body>
    ...
    <div class="feed-container" id="body">
        </div>
    ...
    <div id="newPostToast" style="position: fixed; top: 80px; right: 20px; background: var(--ink-primary); color: white; padding: 1rem; border-radius: 4px; opacity: 0; transform: translateY(-20px); transition: 0.3s; z-index: 2000; display: flex; align-items: center; justify-content: space-between; min-width: 250px;">
        <div id="toastContent" style="font-size: 0.9rem; cursor: pointer;"></div>
        <button onclick="document.getElementById('newPostToast').style.opacity='0'" style="background:none; border:none; color:white; cursor:pointer; font-size:1.2rem;">&times;</button>
    </div>
