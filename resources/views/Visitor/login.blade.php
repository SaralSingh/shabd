...
@section('title', 'Sign In - Shabd')
@section('meta_description', 'Log in to your Shabd account to share your stories and connect with the community of writers and readers, curated by Saral Singh.')
@section('meta_keywords', 'login, sign in, Shabd, blogging community, Saral Singh, writing platform')

@push('styles')
<style>
/* Override body for auth center */
body.guest-layout {
    display: flex;
    align-items: center;
...
@media (max-width: 900px) {
    ...
    body.guest-layout { overflow-y: auto; }
}
</style>
@endpush
